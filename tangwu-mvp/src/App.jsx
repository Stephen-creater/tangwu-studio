...
const semanticAnswerRules = {
  ...
  "archive-secret": [
    ...
    {
      any: ["第三只碗", "第三套餐具", "碗", "餐具", "牙印"],
      answer: "是",
      clueId: "archive-third-bowl"
    },
    {
      any: ["药", "药渍", "药汤", "服药", "病情", "病人", "苦药"],
      answer: "是",
      clueId: "archive-medicine"
    },
    {
      any: ["扶手", "楼梯", "磨痕", "行动不便", "借力", "低处", "老人"],
      answer: "是",
      clueId: "archive-railing"
    },
    {
      any: ["屋主", "主人", "母亲", "老人", "家人", "隐瞒", "撒谎", "官簿", "户籍", "债主", "房契", "报死"],
      answer: "是",
      clueId: "archive-elder"
    }
  ],
